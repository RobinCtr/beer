<div class="wp-block-group__inner-container">
  ...
  <p>
    Dotxeo.com mejor conocido como Dotxeo, con domicilio en
    San Mateo Atenco, Toluca, Estado de Mexico,Mexico y
    portal de internet http://localhost/Dotxeo/public/, es
    el responsable del uso y protección de sus datos
    personales, y al respecto le informamos lo siguiente:
  </p>
  <p>
    <strong>¿Para qué fines utilizaremos sus datos
      personales?</strong>
  </p>
  <p>
  ...
  <p>
    Respuesta a mensajes del formulario de contacto<br />Mantener
    contacto con el usuario
  </p>
  <p>
    <strong>¿Qué datos personales utilizaremos para estos
      fines?</strong>
  </p>
  <p>
  ...
  <p>
    Datos de identificación y contacto, Datos laborales<br />
  </p>
  <p>
    <br /><br /><strong>¿Cómo puede acceder, rectificar o cancelar sus datos
  ...
  <p>
    ...
    al221910393@gmail.com y deberá contener:
  </p>
  <ul>
  ...
  <p>
    ...
    solicitud?<br />Al mismo correo electrónico de donde se
    envío la petición.
  </p>
  <p>
    <strong>El uso de tecnologías de rastreo en nuestro portal de
      internet</strong>
  </p>
  <p>
  ...
  <p>
    ...
    sesión, Fecha y hora del inicio y final de una sesión de
    un usuario<br />
  </p>
  <p>
  ...
  <p>
    <strong>¿Cómo puede conocer los cambios en este aviso de
      privacidad?</strong>
  </p>
  <p>
    ...
    sitio web http://localhost/Dotxeo/public/.
  </p>
  <p id="aviso-format">
    Última actualización de este
    <a aria-label="aviso de privacidad (opens in a new tab)" rel="noopener" href="https://markethax.com/generador-aviso-de-privacidad/" target="_blank" class="rank-math-link">aviso de privacidad</a>: 19/03/2022
  </p>
</div>
</div>